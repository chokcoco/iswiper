(function(name, definition) {
    ...
    Swiper.prototype._copy = function() {
        var me = this;
        var cloneNode = me.$items[0].cloneNode(true);
    ...
    function isLoop(index, swiper){
        if(index == swiper.count){
            ...
            var distance = swiper._height * swiper.count * (swiper._loop + 1);

            if (swiper._options.direction === 'horizontal') {
                distance = swiper._width * swiper.count * (swiper._loop + 1);
            }
